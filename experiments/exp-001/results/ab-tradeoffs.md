...
Generated from `experiments/exp-000/results/ab-results.json` (2026-09-24T19:42:58.340975+00:00).
...
| Wall-clock to reconstruct | 12 ms | 8 ms |  |
...
| p95 proposal latency (W7 corpus, n=500, concurrent-burst conditions) | 52.6 | 55.3 | ms — both well under the 500ms SLO; baseline measurably lower under burst load, see implementation-notes.md for the freshness-retry mechanism that explains most of the gap |
| p95 hot read | 0.4 | 0.3 | ms, n=30 — both sub-2ms, no material difference |
| Ingestion lag (WMS write -> own read path reflects it) | 2954.7 ms mean | 725.4 ms mean | n=5 trials — see docs/experiment/implementation-notes.md item 1 for the two-watermark-vs-one design difference this reflects |
